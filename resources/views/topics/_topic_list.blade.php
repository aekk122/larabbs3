		...
		<li class="meida">
			<div class="media-left">
				<a href="{{ route('users.show', $topic->user_id) }}">
					<img class="media-object img-thumbnail" style="width: 52px; height: 52px;" src="{{ $topic->belongsToUser->avatar }}" title="{{ $topic->belongsToUser->name }}">
				</a>
			</div>
